...
sys.path.append('/home/hc/github/simple-object-detection/object_detection/models')
sys.path.append('/home/hc/github/simple-object-detection/object_detection/models/slim')
...
if __name__ == '__main__':
    ...
    PATH_TO_TEST_IMAGES_DIR = 'images/2011_09_28/2011_09_28_drive_0016_extract/image_03/data'
    # TEST_IMAGE_PATHS = [ os.path.join(PATH_TO_TEST_IMAGES_DIR, 'teste-{}.jpg'.format(i)) for i in range(1, 7) ]
    TEST_IMAGE_PATHS = [ os.path.join(PATH_TO_TEST_IMAGES_DIR, '0000000{}.png'.format(str(i).zfill(3))) for i in range(100, 120) ]
    ...
    with detection_graph.as_default():
        with tf.Session(graph=detection_graph,config=tf.ConfigProto(log_device_placement=False)) as sess:
            for image_path in TEST_IMAGE_PATHS:
                ...
                plt.imshow(image_np)
                #plt.show()
                PATH_TO_OUTPUT_DIR = '/home/hc/github/simple-object-detection/output/'
                img_path, img_filename = os.path.split(image_path)
                plt.savefig(PATH_TO_OUTPUT_DIR+img_filename)
